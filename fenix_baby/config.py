...
# Load .env file for VPS deployment
load_dotenv()
...
MONGO_DB_NAME = os.getenv("MONGO_DB_NAME", "fenix_baby_db")
ELITE_LLM_BASE_URL = os.getenv("ELITE_LLM_BASE_URL", "https://elite-llms-pro-042f44b0a301.herokuapp.com/v1")
ELITE_LLM_API_KEY = os.getenv("ELITE_LLM_API_KEY", "")
ELITE_LLM_MODEL = os.getenv("ELITE_LLM_MODEL", "gpt-5-mini")
ELITE_LLM_UTILITY_MODEL = os.getenv("ELITE_LLM_UTILITY_MODEL", "gpt-4o-mini")
PORT = int(os.environ.get("PORT", 5000))

# Updater Config
UPSTREAM_REPO = os.getenv("UPSTREAM_REPO", "https://github.com/SkyBotsDeveloper/FenixBaby")
...
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "https://t.me/FenixMusicSupport")
SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/FenixMusicSupport")
OWNER_LINK = os.getenv("OWNER_LINK", "https://t.me/llFenixxll")
OWNER_HANDLE = os.getenv("OWNER_HANDLE", "@llFenixxll")
